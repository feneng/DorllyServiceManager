...
var InitiateEditFormTable = function () {
    return {
        init: function () {
            //Datatable Initiating
            var oTable = $('#editFormTable').dataTable({
                "aLengthMenu": [
                    [5, 15, 20, 100, -1],
                    [5, 15, 20, 100, "All"]
                ],
            ...
            //Add New Row
            $('#editFormTable_new').click(function (e) {
                e.preventDefault();
                var aiNew = oTable.fnAddData(['', '', '', '',
                    '<a href="#" class="btn btn-success btn-xs save"><i class="fa fa-edit"></i> Save</a> <a href="#" class="btn btn-warning btn-xs cancel"><i class="fa fa-times"></i> Cancel</a>'
                ]);
            ...
            //Delete an Existing Row
            $('#editFormTable').on("click", 'a.delete', function (e) {
                e.preventDefault();
            ...
            //Cancel Editing or Adding a Row
            $('#editFormTable').on("click", 'a.cancel', function (e) {
                e.preventDefault();
                if ($(this).attr("data-mode") == "new") {
                    var nRow = $(this).parents('tr')[0];
                    oTable.fnDeleteRow(nRow);
            ...
            //Edit A Row
            $('#editFormTable').on("click", 'a.edit', function (e) {
                e.preventDefault();
            ...
            //Save an Editing Row
            $('#editFormTable').on("click", 'a.save', function (e) {
                e.preventDefault();
                if (this.innerHTML.indexOf("Save") >= 0) {
                    saveRow(oTable, isEditing);
                    isEditing = null;
